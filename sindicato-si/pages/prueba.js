        ...
        >
          <div className='text-center'>
            ...
            <div className='flex justify-center mt-8'>
              <a
                className='px-8 mr-6 py-2 text-lg font-medium text-white transition-colors duration-300 transform bg-indigo-600 rounded hover:bg-indigo-500'
                href='https://sindicatodechoferesstaisabel.com/'
              >
                Acceso a portal educativo
              </a>
              <a
                className='px-8 py-2 text-lg font-medium text-indigo-600 transition-colors duration-300 transform bg-white rounded hover:bg-gray-200'
                href='#inscripciones'
              >
                Inscribirse
              </a>
          ...
          <div className='items-center md:flex md:space-x-6'>
            <div className='md:w-1/2'>
              ...
              <p className='max-w-md mt-4 text-gray-600'>
                ...
                profesional, realizamos exámenes psicosensométricos y mucho mas.
              </p>
              <a
                href='tel:0997368340'
